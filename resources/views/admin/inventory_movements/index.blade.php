...
@section('content')
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section class="mt-4 rounded-xl bg-white dark:bg-gray-800 shadow-md p-4 sm:p-5">
            <form method="GET" action="{{ route('inventory_movements.search') }}" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-3 items-end">
                <input type="hidden" name="sort" value="{{ request('sort', 'id') }}">
                <input type="hidden" name="direction" value="{{ request('direction', 'desc') }}">
                <div class="sm:col-span-2">
                    ...
                    <input type="text" name="search" id="search" value="{{ request('search') }}"
                           ...
                           placeholder="Usuario, producto o notas...">
                </div>
                <div>
                ...
                <div>
                    <label for="user_id" class="block text-xs font-semibold uppercase tracking-wide text-gray-600 dark:text-gray-300 mb-1">Usuario</label>
                ...
                <div>
                    <label for="color_id" class="block text-xs font-semibold uppercase tracking-wide text-gray-600 dark:text-gray-300 mb-1">Color</label>
                ...
                <div>
                    <label for="size_id" class="block text-xs font-semibold uppercase tracking-wide text-gray-600 dark:text-gray-300 mb-1">Talla</label>
                ...
                <div>
                    <label for="type" class="block text-xs font-semibold uppercase tracking-wide text-gray-600 dark:text-gray-300 mb-1">Tipo</label>
                ...
                <div class="sm:col-span-2 lg:col-span-6 flex gap-2">
                    ...
                    @if(request()->hasAny(['search','per_page','user_id','product_id','warehouse_id','color_id','size_id','type']))
                        <a href="{{ route('inventory_movements.index') }}" class="inline-flex items-center justify-center gap-2 px-4 py-2 w-full sm:w-auto text-sm font-medium rounded-lg bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-200">
