<div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
    ...
    <label class="block text-sm">
        ...
        <div class="relative text-gray-500 focus-within:text-purple-600 dark:focus-within:text-purple-400">
            <input name="name"
                ...
                placeholder="Escribe un nombre..." value="{{ old('name', isset($department) ? $department->name : '') }}" required />
    ...
    <label class="block mt-4 text-sm">
        ...
        <div class="relative text-gray-500 focus-within:text-purple-600 dark:focus-within:text-purple-400">
            <textarea name="description"
                ...
                rows="3" placeholder="Escribe una descripción...">{{ old('description', isset($department) ? $department->description : '') }}</textarea>
    ...
    <div class="mt-6">
        <button type="submit"
            ...
            <i class="fas fa-paper-plane mr-2"></i> {{ isset($department) ? 'Actualizar' : 'Guardar' }}
        </button>
    </div>
</div>
