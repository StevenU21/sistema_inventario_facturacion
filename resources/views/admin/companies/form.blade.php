<div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
    ...
    <label class="block text-sm">
        ...
        <div class="relative text-gray-500 focus-within:text-purple-600 dark:focus-within:text-purple-400">
            <input name="name"
                ...
                placeholder="Escribe un nombre..." value="{{ old('name', isset($company) ? $company->name : '') }}" required />
    ...
    <label class="block mt-4 text-sm">
        ...
        <div class="relative text-gray-500 focus-within:text-purple-600 dark:focus-within:text-purple-400">
            <input name="ruc"
                class="block w-full pl-10 mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-input focus:border-purple-400 focus:shadow-outline-purple dark:focus:shadow-outline-gray"
                placeholder="Escribe el RUC..." value="{{ old('ruc', isset($company) ? $company->ruc : '') }}" required />
            <div class="absolute inset-y-0 flex items-center ml-3 pointer-events-none">
    ...
    <label class="block mt-4 text-sm">
        ...
        <div class="relative text-gray-500 focus-within:text-purple-600 dark:focus-within:text-purple-400">
            <input type="file" name="logo"
                class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-input focus:border-purple-400 focus:shadow-outline-purple dark:focus:shadow-outline-gray" />
            <div class="absolute inset-y-0 flex items-center ml-3 pointer-events-none">
    ...
    <label class="block mt-4 text-sm">
        ...
        <div class="relative text-gray-500 focus-within:text-purple-600 dark:focus-within:text-purple-400">
            <textarea name="description"
                ...
                rows="3" placeholder="Escribe una descripción...">{{ old('description', isset($company) ? $company->description : '') }}</textarea>
    ...
    <label class="block mt-4 text-sm">
        ...
        <div class="relative text-gray-500 focus-within:text-purple-600 dark:focus-within:text-purple-400">
            <input name="address"
                class="block w-full pl-10 mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-input focus:border-purple-400 focus:shadow-outline-purple dark:focus:shadow-outline-gray"
                placeholder="Escribe la dirección..." value="{{ old('address', isset($company) ? $company->address : '') }}" required />
            <div class="absolute inset-y-0 flex items-center ml-3 pointer-events-none">
    ...
    <label class="block mt-4 text-sm">
        ...
        <div class="relative text-gray-500 focus-within:text-purple-600 dark:focus-within:text-purple-400">
            <input name="phone"
                class="block w-full pl-10 mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-input focus:border-purple-400 focus:shadow-outline-purple dark:focus:shadow-outline-gray"
                placeholder="Escribe el teléfono..." value="{{ old('phone', isset($company) ? $company->phone : '') }}" />
            <div class="absolute inset-y-0 flex items-center ml-3 pointer-events-none">
    ...
    <label class="block mt-4 text-sm">
        ...
        <div class="relative text-gray-500 focus-within:text-purple-600 dark:focus-within:text-purple-400">
            <input name="email" type="email"
                class="block w-full pl-10 mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-input focus:border-purple-400 focus:shadow-outline-purple dark:focus:shadow-outline-gray"
                placeholder="Escribe el email..." value="{{ old('email', isset($company) ? $company->email : '') }}" required />
            <div class="absolute inset-y-0 flex items-center ml-3 pointer-events-none">
