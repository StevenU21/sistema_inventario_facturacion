...
@section('content')
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section class="mt-4 rounded-xl bg-white dark:bg-gray-800 shadow-md p-4 sm:p-5">
            <form method="GET" action="{{ route('purchases.search') }}" class="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 gap-3 items-end">
                ...
                <div>
                    <label for="payment_method_id" class="block text-xs font-semibold uppercase tracking-wide text-gray-600 dark:text-gray-300 mb-1">Método</label>
                ...
                <div>
                    <label for="warehouse_id" class="block text-xs font-semibold uppercase tracking-wide text-gray-600 dark:text-gray-300 mb-1">Almacén</label>
                ...
                <div>
                    <label for="product_id" class="block text-xs font-semibold uppercase tracking-wide text-gray-600 dark:text-gray-300 mb-1">Producto</label>
                ...
                <div class="sm:col-span-3 lg:col-span-4 flex gap-2">
                    ...
                    @if(request()->hasAny(['search','per_page','payment_method_id','entity_id','warehouse_id','product_id','from','to']))
                        <a href="{{ route('purchases.index') }}" class="inline-flex items-center justify-center gap-2 px-4 py-2 w-full sm:w-auto text-sm font-medium rounded-lg bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-200">
                        ...
                        @forelse($purchases as $purchase)
                            <tr class="text-gray-700 dark:text-gray-300 hover:bg-gray-50/60 dark:hover:bg-gray-700/50 transition-colors">
                                <td class="px-4 py-3 text-xs">
                                    <span class="px-2 py-1 font-semibold leading-tight text-white bg-purple-600 rounded-full dark:bg-purple-700 dark:text-white">{{ $purchase->id }}</span>
                                </td>
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center gap-2 text-sm">
                                        ...
                                        <form action="{{ route('purchases.destroy', $purchase) }}" method="POST" onsubmit="return confirm('¿Eliminar esta compra?');">
                                            @csrf @method('DELETE')
