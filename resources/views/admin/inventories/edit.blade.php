        ...
        <section class="relative overflow-hidden rounded-2xl bg-gradient-to-r from-purple-600 to-indigo-600 shadow-lg animate-gradient">
            ...
            <div class="relative p-6 sm:p-8">
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('inventories.show', $inventory) }}" class="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-white/10 hover:bg-white/15 text-white text-sm font-medium backdrop-blur transition">
