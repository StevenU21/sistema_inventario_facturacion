        ...
        <ol class="flex items-center gap-2">
            <li>
                <a href="#" class="hover:text-gray-700 dark:hover:text-gray-200 transition-colors">
                    <i class="fas fa-home mr-1"></i> Módulo de Ventas
                </a>
            </li>
            <li class="text-gray-400">/</li>
            <li>
                <span class="text-gray-700 dark:text-gray-200">Registrar Venta</span>
            </li>
        </ol>
    </nav>
                ...
                <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        <h1 class="text-2xl sm:text-3xl font-extrabold text-white tracking-tight flex items-center">
                            <i class="fas fa-shopping-basket text-white/90 mr-3"></i>
                            Crear Venta
                        </h1>
                        <p class="mt-1 text-white/80 text-sm">Registra una nueva venta.
                        </p>
                    </div>
