...
@section('content')
    <div class="container mx-auto px-4 sm:px-6 lg:px-8" x-data="{
        ...
        <section class="mt-4 rounded-xl bg-white dark:bg-gray-800 shadow-md p-4 sm:p-5">
            <form method="GET" action="{{ route('entities.search') }}" class="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 gap-3 items-end">
                <div>
                ...
                <div>
                    <label for="is_client" class="block text-xs font-semibold uppercase tracking-wide text-gray-600 dark:text-gray-300 mb-1">Cliente</label>
                ...
                <div>
                    <label for="is_supplier" class="block text-xs font-semibold uppercase tracking-wide text-gray-600 dark:text-gray-300 mb-1">Proveedor</label>
                ...
                <div>
                    <label for="is_active" class="block text-xs font-semibold uppercase tracking-wide text-gray-600 dark:text-gray-300 mb-1">Activo</label>
                ...
                <div class="sm:col-span-3 lg:col-span-4 flex gap-2">
                    ...
                    @if(request()->hasAny(['search','per_page','is_client','is_supplier','is_active']))
                        <a href="{{ route('entities.index') }}" class="inline-flex items-center justify-center gap-2 px-4 py-2 w-full sm:w-auto text-sm font-medium rounded-lg bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-200">
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center gap-2 text-sm">
                                        ...
                                        <form action="{{ route('entities.destroy', $entity) }}" method="POST"
                                            ...
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" title="{{ $entity->is_active ? 'Desactivar' : 'Activar' }}"
