        ...
        <div class="flex flex-row justify-between w-full">
            <label
                ...
                <input type="checkbox" name="is_client" value="1"
                    ...
                    @if(!empty($useAlpine)) x-model="editEntity?.is_client" @endif
                    class="form-checkbox h-5 w-5 text-purple-600 border border-gray-300 focus:border-purple-400 focus:ring-2 focus:ring-purple-200 dark:border-gray-600 dark:bg-gray-700" />
            ...
            <label
                ...
                <input type="checkbox" name="is_supplier" value="1"
                    ...
                    @if(!empty($useAlpine)) x-model="editEntity?.is_supplier" @endif
                    class="form-checkbox h-5 w-5 text-purple-600 border border-gray-300 focus:border-purple-400 focus:ring-2 focus:ring-purple-200 dark:border-gray-600 dark:bg-gray-700" />
                <div class="ml-3 flex-1">
                    <div class="flex items-center gap-2">
            ...
            <label
                ...
                <input type="checkbox" name="is_active" value="1"
                    ...
                    @if(!empty($useAlpine)) x-model="editEntity?.is_active" @endif
                    class="form-checkbox h-5 w-5 text-purple-600 border border-gray-300 focus:border-purple-400 focus:ring-2 focus:ring-purple-200 dark:border-gray-600 dark:bg-gray-700" />
                <div class="ml-3 flex-1">
                    <div class="flex items-center gap-2">
        ...
        <label class="block text-sm w-full">
            ...
            <div class="relative text-gray-500 focus-within:text-purple-600 dark:focus-within:text-purple-400">
                <input name="first_name" type="text"
                    ...
                    @if(!empty($useAlpine)) x-model="editEntity?.first_name" @endif
        ...
        <label class="block text-sm w-full">
            ...
            <div class="relative text-gray-500 focus-within:text-purple-600 dark:focus-within:text-purple-400">
                <input name="last_name" type="text"
                    ...
                    @if(!empty($useAlpine)) x-model="editEntity?.last_name" @endif
        ...
        <label class="block text-sm w-full">
            ...
            <div class="relative text-gray-500 focus-within:text-purple-600 dark:focus-within:text-purple-400">
                <input name="identity_card" type="text"
                    ...
                    @if(!empty($useAlpine)) x-model="editEntity?.identity_card" @endif
        ...
        <label class="block text-sm w-full">
            ...
            <div class="relative text-gray-500 focus-within:text-purple-600 dark:focus-within:text-purple-400">
                <input name="ruc" type="text"
                    ...
                    @if(!empty($useAlpine)) x-model="editEntity?.ruc" @endif />
                <div class="absolute inset-y-0 flex items-center ml-3 pointer-events-none">
                    <i class="fas fa-id-card w-5 h-5"></i>
                </div>
            </div>
        ...
        <label class="block text-sm w-full">
            ...
            <div class="relative text-gray-500 focus-within:text-purple-600 dark:focus-within:text-purple-400">
                <input name="phone" type="text"
                    ...
                    placeholder="Teléfono..." @if(!empty($useAlpine)) x-model="editEntity?.phone" @endif value="{{ old('phone', isset($entity) ? $entity->phone : '') }}" />
                <div class="absolute inset-y-0 flex items-center ml-3 pointer-events-none">
    ...
    <label class="block mt-4 text-sm w-full">
        ...
        <div class="relative text-gray-500 focus-within:text-purple-600 dark:focus-within:text-purple-400">
            <input type="email" name="email"
                ...
                placeholder="Correo electrónico..." @if(!empty($useAlpine)) x-model="editEntity?.email" @endif value="{{ old('email', isset($entity) ? $entity->email : '') }}"
                required />
            <div class="absolute inset-y-0 flex items-center ml-3 pointer-events-none">
        ...
        <label class="block text-sm w-full">
            ...
            <div class="relative text-gray-500 focus-within:text-purple-600 dark:focus-within:text-purple-400">
                <select name="department_id" id="department_id"
                    ...
                    @if(!empty($useAlpine)) x-model="editEntity?.department_id" x-effect="window.filterMunicipalitiesForForm && window.filterMunicipalitiesForForm($el.closest('form'))" @endif
                    required>
        ...
        <label class="block text-sm w-full">
            ...
            <div class="relative text-gray-500 focus-within:text-purple-600 dark:focus-within:text-purple-400">
                <select name="municipality_id" id="municipality_id"
                    ...
                    @if(!empty($useAlpine)) x-model="editEntity?.municipality_id" @endif
                    required>
    ...
    <label class="block mt-4 text-sm w-full">
        ...
        <div class="relative text-gray-500 focus-within:text-purple-600 dark:focus-within:text-purple-400">
            <input name="address" type="text"
                ...
                placeholder="Dirección..." @if(!empty($useAlpine)) x-model="editEntity?.address" @endif value="{{ old('address', isset($entity) ? $entity->address : '') }}" />
            <div class="absolute inset-y-0 flex items-center ml-3 pointer-events-none">
    ...
    <label class="block mt-4 text-sm w-full">
        ...
        <div class="relative text-gray-500 focus-within:text-purple-600 dark:focus-within:text-purple-400">
            <textarea name="description"
                ...
                rows="3" placeholder="Escribe una descripción..." @if(!empty($useAlpine)) x-model="editEntity?.description" @endif>{{ old('description', isset($entity) ? $entity->description : '') }}</textarea>
...
<script>
    // Helper global para permitir que Alpine dispare el filtrado con x-effect
    window.filterMunicipalitiesForForm = function(form) {
        const departmentSelect = form?.querySelector('select#department_id');
        const municipalitySelect = form?.querySelector('select#municipality_id');
        ...
        Array.from(municipalitySelect.options).forEach(option => {
            ...
            option.style.display = (!departmentId || optDept === departmentId) ? '' : 'none';
        });
        // Si el municipio seleccionado ya no corresponde, reset
        const sel = municipalitySelect.selectedOptions[0];
    ...
    document.addEventListener('DOMContentLoaded', function() {
        // Soporta múltiples formularios (crear y editar). Usamos closest('form') para scope.
        document.querySelectorAll('select#department_id').forEach(function(departmentSelect) {
            ...
            function filterMunicipalities() {
                window.filterMunicipalitiesForForm(form);
            }

            departmentSelect.addEventListener('change', filterMunicipalities);
            // Inicial: aplica filtro al cargar (crear/editar)
