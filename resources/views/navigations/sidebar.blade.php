    ...
    <div class="py-4 text-gray-500 dark:text-gray-400">
        ...
        <ul class="mt-6">
            ...
            @if (Gate::allows('read sales') ||
                    Gate::allows('read quotations') ||
                    Gate::allows('read accounts receivable') ||
                    Gate::allows('read payments'))
                <li class="relative px-6 py-3" x-data="salesDropdownMenu()" x-init="initSalesDropdown()">
                    ...
                    <ul x-show="isOpen" x-transition:enter="transition ease-out duration-300"
                        ...
                        @can('read account_receivables')
                            <li class="px-6 py-2">
                                <x-ui.submit-link :href="route('admin.accounts_receivable.index')" :active-class="Route::is('admin.accounts_receivable.*')
            ...
            @if (Gate::allows('read purchases') || Gate::allows('read suppliers') || Gate::allows('read clients'))
                <li class="relative px-6 py-3" x-data="purchaseDropdownMenu()" x-init="initPurchaseDropdown()">
                    ...
                    <ul x-show="isOpen" x-transition:enter="transition ease-out duration-300"
                        ...
                        @endcan
                        @if (Gate::allows('read suppliers') || Gate::allows('read clients'))
                            <li class="px-6 py-2">
        ...
        <ul>
            ...
            @if (Gate::allows('read products') ||
                    Gate::allows('read inventories') ||
                    Gate::allows('read inventory_movements') ||
                    Gate::allows('read warehouses') ||
                    Gate::allows('read kardex'))
            ...
            <!-- Catálogo Dropdown -->
            @if (Gate::allows('read categories') ||
                    Gate::allows('read brands') ||
                    Gate::allows('read colors') ||
                    Gate::allows('read sizes') ||
                    Gate::allows('read unit_measures') ||
                    Gate::allows('read taxes'))
            ...
            @if (Gate::allows('read users') ||
                    Gate::allows('read roles') ||
                    Gate::allows('read audits') ||
                    Gate::allows('read companies'))
