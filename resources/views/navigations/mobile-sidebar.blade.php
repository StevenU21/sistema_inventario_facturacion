        ...
        <ul>
            ...
            <li class="relative px-6 py-3" x-data="{ isOpen: false }">
                ...
                <ul x-show="isOpen" x-transition:enter="transition ease-out duration-300"
                    ...
                    <li class="px-6 py-2">
                        <a class="inline-flex items-center w-full transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 {{ Route::is('taxes.index') ? 'text-gray-800 dark:text-gray-100' : '' }}"
                    ...
                    <li class="px-6 py-2">
                        <a class="inline-flex items-center w-full transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 {{ Route::is('entities.index') ? 'text-gray-800 dark:text-gray-100' : '' }}"
