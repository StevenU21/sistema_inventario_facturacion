...
class PermissionTranslator
{
    ...
    protected static array $translations = [
        ...
        'export product_variants' => 'Exportar variantes de productos',
        ...
        'read product_variants' => 'Ver variantes de productos',
        'create product_variants' => 'Crear variantes de productos',
        'update product_variants' => 'Editar variantes de productos',
        'destroy product_variants' => 'Eliminar variantes de productos',
